...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzFormDisplay(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzExitDisplay(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzConfirmDataChange(&Input, SystemTable, ImageHandle);
                break;
        }
    }
