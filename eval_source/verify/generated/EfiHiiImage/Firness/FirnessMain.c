...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzNewImage(&Input, SystemTable, ImageHandle);
                break;
            case 1:
            ...
            case 2:
                ...
                break;
            case 3:
                Status = FuzzDrawImage(&Input, SystemTable, ImageHandle);
                break;
            case 4:
                Status = FuzzDrawImageId(&Input, SystemTable, ImageHandle);
                break;
        }
    }
