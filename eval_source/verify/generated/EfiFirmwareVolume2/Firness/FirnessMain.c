...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzReadSection(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzGetNextFile(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzReadFile(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzSetVolumeAttributes(&Input, SystemTable, ImageHandle);
                break;
            case 4:
            ...
            case 6:
                ...
                break;
            case 7:
                Status = FuzzGetVolumeAttributes(&Input, SystemTable, ImageHandle);
                break;
        }
    }
