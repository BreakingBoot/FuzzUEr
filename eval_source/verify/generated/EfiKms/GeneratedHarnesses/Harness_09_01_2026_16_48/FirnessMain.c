...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzGetServiceStatus(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzRegisterClient(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzCreateKey(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzGetKey(&Input, SystemTable, ImageHandle);
                break;
            case 4:
                Status = FuzzAddKey(&Input, SystemTable, ImageHandle);
                break;
            case 5:
                Status = FuzzDeleteKey(&Input, SystemTable, ImageHandle);
                break;
            case 6:
                Status = FuzzGetKeyAttributes(&Input, SystemTable, ImageHandle);
                break;
            case 7:
                Status = FuzzAddKeyAttributes(&Input, SystemTable, ImageHandle);
                break;
            case 8:
                Status = FuzzDeleteKeyAttributes(&Input, SystemTable, ImageHandle);
                break;
            case 9:
                Status = FuzzGetKeyByAttributes(&Input, SystemTable, ImageHandle);
                break;
        }
    }
