...
FuzzGetEnv(
    ...
    Status = ProtocolVariable->GetEnv(
        NULL
    );
    return Status;
}
...
FuzzSetEnv(
    ...
    /*
        Input Variable(s)
    */
    CHAR16 * SetEnv_Arg_0 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    CHAR16 * SetEnv_Arg_1 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    BOOLEAN SetEnv_Arg_2 = FALSE;
    ...
    switch(SetEnv_Arg_0_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(SetEnv_Arg_0), (VOID *)SetEnv_Arg_0);
            break;
        case 1:
        {
    ...
    switch(SetEnv_Arg_1_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(SetEnv_Arg_1), (VOID *)SetEnv_Arg_1);
            break;
        case 1:
        {
...
FuzzGetAlias(
    ...
    /*
        Input Variable(s)
    */
    CHAR16 * GetAlias_Arg_0 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    switch(GetAlias_Arg_0_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(GetAlias_Arg_0), (VOID *)GetAlias_Arg_0);
            break;
        case 1:
        {
    ...
    Status = ProtocolVariable->GetAlias(
        GetAlias_Arg_0,
        NULL
    );
    return Status;
...
FuzzSetAlias(
    ...
    /*
        Input Variable(s)
    */
    CHAR16 * SetAlias_Arg_0 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    CHAR16 * SetAlias_Arg_1 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    BOOLEAN SetAlias_Arg_2 = FALSE;
    BOOLEAN SetAlias_Arg_3 = FALSE;
    ...
    switch(SetAlias_Arg_0_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(SetAlias_Arg_0), (VOID *)SetAlias_Arg_0);
            break;
        case 1:
        {
    ...
    switch(SetAlias_Arg_1_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(SetAlias_Arg_1), (VOID *)SetAlias_Arg_1);
            break;
        case 1:
        {
...
FuzzGetHelpText(
    ...
    /*
        Input Variable(s)
    */
    CHAR16 * GetHelpText_Arg_0 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    switch(GetHelpText_Arg_0_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(GetHelpText_Arg_0), (VOID *)GetHelpText_Arg_0);
            break;
        case 1:
        {
    ...
    /*
        Output Variable(s)
    */
    CHAR16 * * GetHelpText_Arg_2 = (CHAR16 * *)AllocateZeroPool(sizeof(CHAR16));
...
FuzzGetDevicePathFromMap(
    ...
    /*
        Input Variable(s)
    */
    CHAR16 * GetDevicePathFromMap_Arg_0 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    switch(GetDevicePathFromMap_Arg_0_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(GetDevicePathFromMap_Arg_0), (VOID *)GetDevicePathFromMap_Arg_0);
            break;
        case 1:
        {
    ...
    Status = ProtocolVariable->GetDevicePathFromMap(
...
FuzzGetMapFromDevicePath(
    ...
    */
    ...
    Status = ProtocolVariable->GetMapFromDevicePath(
        &GetMapFromDevicePath_Arg_0
    );
    return Status;
}
...
FuzzGetDevicePathFromFilePath(
    ...
    /*
        Input Variable(s)
    */
    CHAR16 * GetDevicePathFromFilePath_Arg_0 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    switch(GetDevicePathFromFilePath_Arg_0_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(GetDevicePathFromFilePath_Arg_0), (VOID *)GetDevicePathFromFilePath_Arg_0);
            break;
        case 1:
        {
    ...
    Status = ProtocolVariable->GetDevicePathFromFilePath(
...
FuzzGetFilePathFromDevicePath(
    ...
    */
    ...
    Status = ProtocolVariable->GetFilePathFromDevicePath(
        GetFilePathFromDevicePath_Arg_0
    );
    return Status;
}
...
FuzzSetMap(
    ...
    */
    ...
    CHAR16 * SetMap_Arg_1 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    switch(SetMap_Arg_1_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(SetMap_Arg_1), (VOID *)SetMap_Arg_1);
            break;
        case 1:
        {
...
FuzzGetCurDir(
    ...
    Status = ProtocolVariable->GetCurDir(
        NULL
    );
    return Status;
}
...
FuzzSetCurDir(
    ...
    /*
        Input Variable(s)
    */
    CHAR16 * SetCurDir_Arg_1 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    switch(SetCurDir_Arg_1_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(SetCurDir_Arg_1), (VOID *)SetCurDir_Arg_1);
            break;
        case 1:
        {
...
FuzzOpenFileList(
    ...
    /*
        Input Variable(s)
    */
    CHAR16 * OpenFileList_Arg_0 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    switch(OpenFileList_Arg_0_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(OpenFileList_Arg_0), (VOID *)OpenFileList_Arg_0);
            break;
        case 1:
        {
...
FuzzGetDeviceName(
    ...
    */
    ...
    CHAR8 * GetDeviceName_Arg_2 = (CHAR8 *)AllocateZeroPool(sizeof(CHAR8));
    ...
    switch(GetDeviceName_Arg_2_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(GetDeviceName_Arg_2), (VOID *)GetDeviceName_Arg_2);
            break;
        case 1:
        {
    ...
    /*
        Output Variable(s)
    */
    CHAR16 * * GetDeviceName_Arg_3 = (CHAR16 * *)AllocateZeroPool(sizeof(CHAR16));
...
FuzzGetFileInfo(
    ...
    */
    ...
    switch(*GetFileInfo_Arg_0_choice % 4) {
        ...
        // Generator Struct Variable Initialization
            /*
                Input Variable(s)
            */
            CHAR16 * ShellOpenFileByName_Arg_0 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
            ...
            switch(ShellOpenFileByName_Arg_0_choice % 2) {
                case 0:
                    ReadBytes(Input, sizeof(ShellOpenFileByName_Arg_0), (VOID *)ShellOpenFileByName_Arg_0);
                    break;
                case 1:
                {
        ...
        // Generator Struct Variable Initialization
            /*
                Input Variable(s)
            */
            CHAR16 * ShellCreateDirectory_Arg_0 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
            ...
            switch(ShellCreateDirectory_Arg_0_choice % 2) {
                case 0:
                    ReadBytes(Input, sizeof(ShellCreateDirectory_Arg_0), (VOID *)ShellCreateDirectory_Arg_0);
                    break;
                case 1:
                {
    ...
    Status = ProtocolVariable->GetFileInfo(
        GetFileInfo_Arg_0
    );
    return Status;
}
...
FuzzSetFileInfo(
    ...
    */
    ...
    switch(*SetFileInfo_Arg_1_choice % 3) {
        ...
        {
            EFI_TIME Firness_CreateTime;
            ReadBytes(Input, sizeof(Firness_CreateTime), (VOID *)&Firness_CreateTime);
            SetFileInfo_Arg_1->CreateTime = Firness_CreateTime;
        }
        {
            EFI_TIME Firness_LastAccessTime;
            ReadBytes(Input, sizeof(Firness_LastAccessTime), (VOID *)&Firness_LastAccessTime);
            SetFileInfo_Arg_1->LastAccessTime = Firness_LastAccessTime;
        }
        {
            EFI_TIME Firness_ModificationTime;
            ReadBytes(Input, sizeof(Firness_ModificationTime), (VOID *)&Firness_ModificationTime);
            SetFileInfo_Arg_1->ModificationTime = Firness_ModificationTime;
        }
        {
...
FuzzOpenFileByName(
    ...
    /*
        Input Variable(s)
    */
    CHAR16 * OpenFileByName_Arg_0 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    switch(OpenFileByName_Arg_0_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(OpenFileByName_Arg_0), (VOID *)OpenFileByName_Arg_0);
            break;
        case 1:
        {
...
FuzzCreateFile(
    ...
    /*
        Input Variable(s)
    */
    CHAR16 * CreateFile_Arg_0 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    switch(CreateFile_Arg_0_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(CreateFile_Arg_0), (VOID *)CreateFile_Arg_0);
            break;
        case 1:
        {
...
FuzzDeleteFileByName(
    ...
    /*
        Input Variable(s)
    */
    CHAR16 * DeleteFileByName_Arg_0 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    switch(DeleteFileByName_Arg_0_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(DeleteFileByName_Arg_0), (VOID *)DeleteFileByName_Arg_0);
            break;
        case 1:
        {
...
FuzzFindFiles(
    ...
    /*
        Input Variable(s)
    */
    CHAR16 * FindFiles_Arg_0 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    switch(FindFiles_Arg_0_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(FindFiles_Arg_0), (VOID *)FindFiles_Arg_0);
            break;
        case 1:
        {
...
FuzzRegisterGuidName(
    ...
    */
    ...
    CHAR16 * RegisterGuidName_Arg_1 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    switch(RegisterGuidName_Arg_1_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(RegisterGuidName_Arg_1), (VOID *)RegisterGuidName_Arg_1);
            break;
        case 1:
        {
...
FuzzGetGuidName(
    ...
    */
    ...
    /*
        Output Variable(s)
    */
    CHAR16 * * GetGuidName_Arg_1 = (CHAR16 * *)AllocateZeroPool(sizeof(CHAR16));
...
FuzzGetGuidFromName(
    ...
    /*
        Input Variable(s)
    */
    CHAR16 * GetGuidFromName_Arg_0 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    switch(GetGuidFromName_Arg_0_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(GetGuidFromName_Arg_0), (VOID *)GetGuidFromName_Arg_0);
            break;
        case 1:
        {
...
FuzzGetEnvEx(
    ...
    /*
        Input Variable(s)
    */
    CHAR16 * GetEnvEx_Arg_0 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    switch(GetEnvEx_Arg_0_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(GetEnvEx_Arg_0), (VOID *)GetEnvEx_Arg_0);
            break;
        case 1:
        {
    ...
    Status = ProtocolVariable->GetEnvEx(
        GetEnvEx_Arg_0,
        NULL
    );
    return Status;
