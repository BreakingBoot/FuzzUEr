...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzSetOptions(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzForceDefaults(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzOptionsValid(&Input, SystemTable, ImageHandle);
                break;
        }
    }
