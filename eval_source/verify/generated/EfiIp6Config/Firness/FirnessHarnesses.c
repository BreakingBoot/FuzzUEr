...
FuzzGetData(
    ...
    EFI_IP6_CONFIG_PROTOCOL * ProtocolVariable = NULL;
    Status = SystemTable->BootServices->LocateProtocol(&gEfiIp6ConfigProtocolGuid, NULL, (VOID *)&ProtocolVariable);
    if (EFI_ERROR(Status)) {
        return Status;
    }
    /*
        Input Variable(s)
    */
    EFI_IP6_CONFIG_DATA_TYPE GetData_Arg_1 = 0;
    ...
    switch(*GetData_Arg_1_choice % 9) {
        case 0:
            GetData_Arg_1 = Ip6ConfigDataTypeAltInterfaceId;
            break;
        case 1:
            GetData_Arg_1 = Ip6ConfigDataTypeDnsServer;
            break;
        case 2:
            GetData_Arg_1 = Ip6ConfigDataTypeDupAddrDetectTransmits;
            break;
        case 3:
            GetData_Arg_1 = Ip6ConfigDataTypeGateway;
            break;
        case 4:
            GetData_Arg_1 = Ip6ConfigDataTypeInterfaceInfo;
            break;
        case 5:
            GetData_Arg_1 = Ip6ConfigDataTypeManualAddress;
            break;
        case 6:
            GetData_Arg_1 = Ip6ConfigDataTypeMaximum;
            break;
        case 7:
            GetData_Arg_1 = Ip6ConfigDataTypePolicy;
            break;
        case 8:
    ...
    switch(*GetData_Arg_3_choice % 4) {
        ...
        switch(*GetData_Arg_3_choice % 3) {
            case 0:
                GetData_Arg_3 = Ip6ConfigPolicyAutomatic;
                break;
            case 1:
                GetData_Arg_3 = Ip6ConfigPolicyManual;
                break;
            case 2:
...
FuzzSetData(
    ...
    /*
        Input Variable(s)
    */
    EFI_IP6_CONFIG_DATA_TYPE SetData_Arg_1 = 0;
    ...
    switch(*SetData_Arg_1_choice % 9) {
        case 0:
            SetData_Arg_1 = Ip6ConfigDataTypeAltInterfaceId;
            break;
        case 1:
            SetData_Arg_1 = Ip6ConfigDataTypeDnsServer;
            break;
        case 2:
            SetData_Arg_1 = Ip6ConfigDataTypeDupAddrDetectTransmits;
            break;
        case 3:
            SetData_Arg_1 = Ip6ConfigDataTypeGateway;
            break;
        case 4:
            SetData_Arg_1 = Ip6ConfigDataTypeInterfaceInfo;
            break;
        case 5:
            SetData_Arg_1 = Ip6ConfigDataTypeManualAddress;
            break;
        case 6:
            SetData_Arg_1 = Ip6ConfigDataTypeMaximum;
            break;
        case 7:
            SetData_Arg_1 = Ip6ConfigDataTypePolicy;
            break;
        case 8:
    ...
    UINT8* SetData_Arg_2_choice = AllocateZeroPool(sizeof(UINT8));
    ReadBytes(Input, sizeof(SetData_Arg_2_choice), (VOID *)SetData_Arg_2_choice);
    switch(*SetData_Arg_2_choice % 3) {
        case 0:
        {
        // Constant Variable Initialization
        SetData_Arg_2 = kEmptyHashValue;
    ...
    switch(*SetData_Arg_3_choice % 3) {
        ...
        switch(*SetData_Arg_3_choice % 3) {
            case 0:
                SetData_Arg_3 = Ip6ConfigPolicyAutomatic;
                break;
            case 1:
                SetData_Arg_3 = Ip6ConfigPolicyManual;
                break;
            case 2:
...
FuzzRegisterDataNotify(
    ...
    /*
        Input Variable(s)
    */
    EFI_IP6_CONFIG_DATA_TYPE RegisterDataNotify_Arg_1 = 0;
    ...
    switch(*RegisterDataNotify_Arg_1_choice % 9) {
        case 0:
            RegisterDataNotify_Arg_1 = Ip6ConfigDataTypeAltInterfaceId;
            break;
        case 1:
            RegisterDataNotify_Arg_1 = Ip6ConfigDataTypeDnsServer;
            break;
        case 2:
            RegisterDataNotify_Arg_1 = Ip6ConfigDataTypeDupAddrDetectTransmits;
            break;
        case 3:
            RegisterDataNotify_Arg_1 = Ip6ConfigDataTypeGateway;
            break;
        case 4:
            RegisterDataNotify_Arg_1 = Ip6ConfigDataTypeInterfaceInfo;
            break;
        case 5:
            RegisterDataNotify_Arg_1 = Ip6ConfigDataTypeManualAddress;
            break;
        case 6:
            RegisterDataNotify_Arg_1 = Ip6ConfigDataTypeMaximum;
            break;
        case 7:
            RegisterDataNotify_Arg_1 = Ip6ConfigDataTypePolicy;
            break;
        case 8:
...
FuzzUnregisterDataNotify(
    ...
    /*
        Input Variable(s)
    */
    EFI_IP6_CONFIG_DATA_TYPE UnregisterDataNotify_Arg_1 = 0;
    ...
    switch(*UnregisterDataNotify_Arg_1_choice % 9) {
        case 0:
            UnregisterDataNotify_Arg_1 = Ip6ConfigDataTypeAltInterfaceId;
            break;
        case 1:
            UnregisterDataNotify_Arg_1 = Ip6ConfigDataTypeDnsServer;
            break;
        case 2:
            UnregisterDataNotify_Arg_1 = Ip6ConfigDataTypeDupAddrDetectTransmits;
            break;
        case 3:
            UnregisterDataNotify_Arg_1 = Ip6ConfigDataTypeGateway;
            break;
        case 4:
            UnregisterDataNotify_Arg_1 = Ip6ConfigDataTypeInterfaceInfo;
            break;
        case 5:
            UnregisterDataNotify_Arg_1 = Ip6ConfigDataTypeManualAddress;
            break;
        case 6:
            UnregisterDataNotify_Arg_1 = Ip6ConfigDataTypeMaximum;
            break;
        case 7:
            UnregisterDataNotify_Arg_1 = Ip6ConfigDataTypePolicy;
            break;
        case 8:
