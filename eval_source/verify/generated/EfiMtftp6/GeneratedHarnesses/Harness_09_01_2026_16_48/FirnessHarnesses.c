...
FuzzPoll(
    ...
    EFI_MTFTP6_PROTOCOL * ProtocolVariable = NULL;
    Status = SystemTable->BootServices->LocateProtocol(&gEfiMtftp6ProtocolGuid, NULL, (VOID *)&ProtocolVariable);
    if (EFI_ERROR(Status)) {
        return Status;
    }
...
FuzzConfigure(
    ...
    /*
        Input Variable(s)
    */
    EFI_MTFTP6_CONFIG_DATA * Configure_Arg_1 = (EFI_MTFTP6_CONFIG_DATA *)AllocateZeroPool(sizeof(EFI_MTFTP6_CONFIG_DATA));
    
    // Generator Struct Variable Initialization
    {
        EFI_IPv6_ADDRESS Firness_StationIp;
    ...
    {
        EFI_IPv6_ADDRESS Firness_ServerIp;
...
FuzzGetInfo(
    ...
    /*
        Input Variable(s)
    */
    EFI_MTFTP6_OVERRIDE_DATA * GetInfo_Arg_1 = (EFI_MTFTP6_OVERRIDE_DATA *)AllocateZeroPool(sizeof(EFI_MTFTP6_OVERRIDE_DATA));
    ...
    EFI_MTFTP6_OPTION * GetInfo_Arg_5 = (EFI_MTFTP6_OPTION *)AllocateZeroPool(sizeof(EFI_MTFTP6_OPTION));
    ...
    */
    ...
    EFI_MTFTP6_PACKET * GetInfo_Arg_7 = (EFI_MTFTP6_PACKET *)AllocateZeroPool(sizeof(EFI_MTFTP6_PACKET));
    ...
    Status = ProtocolVariable->GetInfo(
        ...
        GetInfo_Arg_5,
        GetInfo_Arg_6,
        (EFI_MTFTP6_PACKET **)&GetInfo_Arg_7
    );
    return Status;
}
...
FuzzParseOptions(
    ...
    */
    ...
    EFI_MTFTP6_PACKET * ParseOptions_Arg_2 = (EFI_MTFTP6_PACKET *)AllocateZeroPool(sizeof(EFI_MTFTP6_PACKET));
    ...
    */
    ...
    EFI_MTFTP6_OPTION * ParseOptions_Arg_4 = (EFI_MTFTP6_OPTION *)AllocateZeroPool(sizeof(EFI_MTFTP6_OPTION));
    ...
    Status = ProtocolVariable->ParseOptions(
        ...
        ParseOptions_Arg_2,
        ParseOptions_Arg_3,
        (EFI_MTFTP6_OPTION **)&ParseOptions_Arg_4
    );
    return Status;
}
...
FuzzGetModeData(
    ...
    /*
        Output Variable(s)
    */
    EFI_MTFTP6_MODE_DATA * GetModeData_Arg_1 = (EFI_MTFTP6_MODE_DATA *)AllocateZeroPool(sizeof(EFI_MTFTP6_MODE_DATA));
