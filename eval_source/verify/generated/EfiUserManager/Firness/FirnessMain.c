...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzCurrent(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzGetNextInfo(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzGetInfo(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzCreate(&Input, SystemTable, ImageHandle);
                break;
            case 4:
                Status = FuzzDelete(&Input, SystemTable, ImageHandle);
                break;
            case 5:
                Status = FuzzGetNext(&Input, SystemTable, ImageHandle);
                break;
            case 6:
                Status = FuzzIdentify(&Input, SystemTable, ImageHandle);
                break;
            case 7:
                Status = FuzzFind(&Input, SystemTable, ImageHandle);
                break;
            case 8:
                Status = FuzzNotify(&Input, SystemTable, ImageHandle);
                break;
            case 9:
                Status = FuzzSetInfo(&Input, SystemTable, ImageHandle);
                break;
            case 10:
                Status = FuzzDeleteInfo(&Input, SystemTable, ImageHandle);
                break;
        }
    }
