...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzCreateDevice(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzDeleteDevice(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzDispatchService(&Input, SystemTable, ImageHandle);
                break;
        }
    }
