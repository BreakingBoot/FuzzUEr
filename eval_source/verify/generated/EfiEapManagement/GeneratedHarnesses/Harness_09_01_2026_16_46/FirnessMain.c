...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzGetSystemConfiguration(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzSetSystemConfiguration(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzInitializePort(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzUserLogon(&Input, SystemTable, ImageHandle);
                break;
            case 4:
                Status = FuzzUserLogoff(&Input, SystemTable, ImageHandle);
                break;
            case 5:
                Status = FuzzGetSupplicantStatus(&Input, SystemTable, ImageHandle);
                break;
            case 6:
                Status = FuzzSetSupplicantConfiguration(&Input, SystemTable, ImageHandle);
                break;
            case 7:
                Status = FuzzGetSupplicantStatistics(&Input, SystemTable, ImageHandle);
                break;
        }
    }
