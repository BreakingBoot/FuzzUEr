...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzGetStatus(&Input, SystemTable, ImageHandle);
                break;
            case 1:
            ...
            case 4:
                ...
                break;
            case 5:
                Status = FuzzReceiveFilters(&Input, SystemTable, ImageHandle);
                break;
            case 6:
                Status = FuzzMCastIpToMac(&Input, SystemTable, ImageHandle);
                break;
            case 7:
            ...
            case 8:
                ...
                break;
            case 9:
                Status = FuzzStationAddress(&Input, SystemTable, ImageHandle);
                break;
            case 10:
                Status = FuzzStatistics(&Input, SystemTable, ImageHandle);
                break;
            case 11:
                Status = FuzzNvData(&Input, SystemTable, ImageHandle);
                break;
            case 12:
