...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzGetSupportedTypes(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzGetInformation(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzSetInformation(&Input, SystemTable, ImageHandle);
                break;
        }
    }
