...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzDebugger(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzSignalException(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzDasm(&Input, SystemTable, ImageHandle);
                break;
            case 3:
