...
FuzzGetTargetLun(
    ...
    EFI_EXT_SCSI_PASS_THRU_PROTOCOL * ProtocolVariable = NULL;
    Status = SystemTable->BootServices->LocateProtocol(&gEfiExtScsiPassThruProtocolGuid, NULL, (VOID *)&ProtocolVariable);
    if (EFI_ERROR(Status)) {
        return Status;
    }
    /*
    ...
    */
    ...
    UINT8 * GetTargetLun_Arg_2 = (UINT8 *)AllocateZeroPool(sizeof(UINT8));
...
/*
    This is a harness for fuzzing the protocol service
    called GetNextTargetLun.
*/
__attribute__((no_sanitize("address")))
EFI_STATUS
EFIAPI
FuzzGetNextTargetLun(
    IN INPUT_BUFFER *Input,
    IN EFI_SYSTEM_TABLE *SystemTable,
    IN EFI_HANDLE *ImageHandle
) {
    ...
    /*
        Input Variable(s)
    */
    UINT8 * GetNextTargetLun_Arg_1 = (UINT8 *)AllocateZeroPool(sizeof(UINT8));
    UINT64 * GetNextTargetLun_Arg_2 = (UINT64 *)AllocateZeroPool(sizeof(UINT64));
    
    // Fuzzable Variable Initialization
    UINT8 GetNextTargetLun_Arg_1_choice = 0;
    ReadBytes(Input, sizeof(GetNextTargetLun_Arg_1_choice), (VOID *)&GetNextTargetLun_Arg_1_choice);
    switch(GetNextTargetLun_Arg_1_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(GetNextTargetLun_Arg_1), (VOID *)GetNextTargetLun_Arg_1);
            break;
        case 1:
        {
            gBS->FreePool(GetNextTargetLun_Arg_1);
            GetNextTargetLun_Arg_1 = NULL;
            break;
        }
    }
    
    // Fuzzable Variable Initialization
    UINT8 GetNextTargetLun_Arg_2_choice = 0;
    ReadBytes(Input, sizeof(GetNextTargetLun_Arg_2_choice), (VOID *)&GetNextTargetLun_Arg_2_choice);
    switch(GetNextTargetLun_Arg_2_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(GetNextTargetLun_Arg_2), (VOID *)GetNextTargetLun_Arg_2);
            break;
        case 1:
        {
            gBS->FreePool(GetNextTargetLun_Arg_2);
            GetNextTargetLun_Arg_2 = NULL;
            break;
        }
    }
    
    Status = ProtocolVariable->GetNextTargetLun(
        ProtocolVariable,
        (UINT8 **)&GetNextTargetLun_Arg_1,
        GetNextTargetLun_Arg_2
    );
    return Status;
}
...
FuzzResetTargetLun(
    ...
    /*
        Input Variable(s)
    */
    UINT8 * ResetTargetLun_Arg_1 = (UINT8 *)AllocateZeroPool(sizeof(UINT8));
    UINT64 ResetTargetLun_Arg_2 = 0;
    
    // Fuzzable Variable Initialization
    UINT8 ResetTargetLun_Arg_1_choice = 0;
    ReadBytes(Input, sizeof(ResetTargetLun_Arg_1_choice), (VOID *)&ResetTargetLun_Arg_1_choice);
    switch(ResetTargetLun_Arg_1_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(ResetTargetLun_Arg_1), (VOID *)ResetTargetLun_Arg_1);
            break;
        case 1:
        {
            gBS->FreePool(ResetTargetLun_Arg_1);
            ResetTargetLun_Arg_1 = NULL;
            break;
        }
    }
    
    // Fuzzable Variable Initialization
    ReadBytes(Input, sizeof(ResetTargetLun_Arg_2), (VOID *)&ResetTargetLun_Arg_2);
    
    Status = ProtocolVariable->ResetTargetLun(
        ProtocolVariable,
        ResetTargetLun_Arg_1,
        ResetTargetLun_Arg_2
    );
    return Status;
}
...
FuzzPassThru(
    ...
    /*
        Input Variable(s)
    */
    UINT8 * PassThru_Arg_1 = (UINT8 *)AllocateZeroPool(sizeof(UINT8));
    UINT64 PassThru_Arg_2 = 0;
    EFI_EVENT PassThru_Arg_4 = 0;
    
    // Fuzzable Variable Initialization
    UINT8 PassThru_Arg_1_choice = 0;
...
FuzzBuildDevicePath(
    ...
    /*
        Input Variable(s)
    */
    UINT8 * BuildDevicePath_Arg_1 = (UINT8 *)AllocateZeroPool(sizeof(UINT8));
    ...
    // Fuzzable Variable Initialization
    UINT8 BuildDevicePath_Arg_1_choice = 0;
    ReadBytes(Input, sizeof(BuildDevicePath_Arg_1_choice), (VOID *)&BuildDevicePath_Arg_1_choice);
    switch(BuildDevicePath_Arg_1_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(BuildDevicePath_Arg_1), (VOID *)BuildDevicePath_Arg_1);
            break;
        case 1:
        {
            gBS->FreePool(BuildDevicePath_Arg_1);
            BuildDevicePath_Arg_1 = NULL;
            break;
        }
    }
...
FuzzGetNextTarget(
    ...
    /*
        Input Variable(s)
    */
    UINT8 * GetNextTarget_Arg_1 = (UINT8 *)AllocateZeroPool(sizeof(UINT8));
    
    // Fuzzable Variable Initialization
    UINT8 GetNextTarget_Arg_1_choice = 0;
    ReadBytes(Input, sizeof(GetNextTarget_Arg_1_choice), (VOID *)&GetNextTarget_Arg_1_choice);
    switch(GetNextTarget_Arg_1_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(GetNextTarget_Arg_1), (VOID *)GetNextTarget_Arg_1);
            break;
        case 1:
        {
            gBS->FreePool(GetNextTarget_Arg_1);
            GetNextTarget_Arg_1 = NULL;
            break;
        }
    }
    
    Status = ProtocolVariable->GetNextTarget(
        ProtocolVariable,
        (UINT8 **)&GetNextTarget_Arg_1
    );
    return Status;
}
