    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        switch(DriverChoice%8)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                Status = FuzzHostNameToIp(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzPoll(&Input, SystemTable, ImageHandle);
                break;
            case 4:
                Status = FuzzIpToHostName(&Input, SystemTable, ImageHandle);
                break;
            case 5:
                Status = FuzzGeneralLookUp(&Input, SystemTable, ImageHandle);
                break;
            case 6:
                Status = FuzzUpdateDnsCache(&Input, SystemTable, ImageHandle);
                break;
            case 7:
