...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzBuild(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzTransmitReceive(&Input, SystemTable, ImageHandle);
                break;
            case 2:
            ...
            case 5:
                ...
                break;
            case 6:
                Status = FuzzParse(&Input, SystemTable, ImageHandle);
                break;
            case 7:
                Status = FuzzRenewRebind(&Input, SystemTable, ImageHandle);
                break;
            case 8:
                Status = FuzzRelease(&Input, SystemTable, ImageHandle);
                break;
        }
    }
