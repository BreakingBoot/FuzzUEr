...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzGetDevicePathSize(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzDuplicateDevicePath(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzAppendDevicePath(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzAppendDeviceNode(&Input, SystemTable, ImageHandle);
                break;
            case 4:
                Status = FuzzAppendDevicePathInstance(&Input, SystemTable, ImageHandle);
                break;
            case 5:
                Status = FuzzGetNextDevicePathInstance(&Input, SystemTable, ImageHandle);
                break;
            case 6:
                Status = FuzzIsDevicePathMultiInstance(&Input, SystemTable, ImageHandle);
                break;
            case 7:
                Status = FuzzCreateDeviceNode(&Input, SystemTable, ImageHandle);
                break;
        }
    }
