...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzGetAcpiTable(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzRegisterNotify(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzOpen(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzOpenSdt(&Input, SystemTable, ImageHandle);
                break;
            case 4:
                Status = FuzzClose(&Input, SystemTable, ImageHandle);
                break;
            case 5:
                Status = FuzzGetChild(&Input, SystemTable, ImageHandle);
                break;
            case 6:
                Status = FuzzGetOption(&Input, SystemTable, ImageHandle);
                break;
            case 7:
                Status = FuzzSetOption(&Input, SystemTable, ImageHandle);
                break;
            case 8:
                Status = FuzzFindPath(&Input, SystemTable, ImageHandle);
                break;
        }
    }
