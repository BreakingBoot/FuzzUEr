...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzGetDriver(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzGetDriverPath(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzDriverLoaded(&Input, SystemTable, ImageHandle);
                break;
        }
    }
