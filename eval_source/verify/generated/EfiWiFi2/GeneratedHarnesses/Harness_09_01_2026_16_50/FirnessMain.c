...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzGetNetworks(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzConnectNetwork(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzDisconnectNetwork(&Input, SystemTable, ImageHandle);
                break;
        }
    }
