    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        switch(DriverChoice%4)
        {
            case 0:
                ...
                break;
            case 1:
                Status = FuzzWriteBlocksEx(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzReadBlocksEx(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzFlushBlocksEx(&Input, SystemTable, ImageHandle);
                break;
        }
    }
