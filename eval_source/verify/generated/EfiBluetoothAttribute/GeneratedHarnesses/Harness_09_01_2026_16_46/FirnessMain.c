...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzSendRequest(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzRegisterForServerNotification(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzGetServiceInfo(&Input, SystemTable, ImageHandle);
                break;
            case 3:
