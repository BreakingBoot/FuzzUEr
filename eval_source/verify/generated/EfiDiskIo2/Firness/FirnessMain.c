...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzWriteDiskEx(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzReadDiskEx(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzFlushDiskEx(&Input, SystemTable, ImageHandle);
                break;
            case 3:
