...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzEnroll(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzForm(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzTile(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzTitle(&Input, SystemTable, ImageHandle);
                break;
            case 4:
                Status = FuzzUser(&Input, SystemTable, ImageHandle);
                break;
            case 5:
                Status = FuzzSelect(&Input, SystemTable, ImageHandle);
                break;
            case 6:
                Status = FuzzDeselect(&Input, SystemTable, ImageHandle);
                break;
            case 7:
                Status = FuzzDefault(&Input, SystemTable, ImageHandle);
                break;
            case 8:
