...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzGetHashSize(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzHash(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzHashInit(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzHashUpdate(&Input, SystemTable, ImageHandle);
                break;
            case 4:
                Status = FuzzHashFinal(&Input, SystemTable, ImageHandle);
                break;
        }
    }
