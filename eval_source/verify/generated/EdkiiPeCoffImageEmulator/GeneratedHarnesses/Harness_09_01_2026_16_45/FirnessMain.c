...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzIsImageSupported(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzUnregisterImage(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzRegisterImage(&Input, SystemTable, ImageHandle);
                break;
        }
    }
