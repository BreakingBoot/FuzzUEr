...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzGetRootHpcList(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzGetResourcePadding(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzInitializeRootHpc(&Input, SystemTable, ImageHandle);
                break;
        }
    }
