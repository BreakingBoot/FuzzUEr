...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzSendReceive(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzGetServiceTime(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzGetService(&Input, SystemTable, ImageHandle);
                break;
            case 3:
            ...
            case 4:
                ...
                break;
            case 5:
                Status = FuzzAyncSendReceive(&Input, SystemTable, ImageHandle);
                break;
            case 6:
                Status = FuzzEventService(&Input, SystemTable, ImageHandle);
                break;
        }
    }
