    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        switch(DriverChoice%5)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                Status = FuzzGetNextSelector(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzRegisterDataNotify(&Input, SystemTable, ImageHandle);
                break;
            case 4:
                Status = FuzzUnregisterDataNotify(&Input, SystemTable, ImageHandle);
                break;
        }
    }
