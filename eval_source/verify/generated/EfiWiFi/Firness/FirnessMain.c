    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        switch(DriverChoice%5)
        {
            case 0:
                ...
                break;
            case 1:
                Status = FuzzAssociate(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzDisassociate(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzAuthenticate(&Input, SystemTable, ImageHandle);
                break;
            case 4:
                Status = FuzzDeauthenticate(&Input, SystemTable, ImageHandle);
                break;
        }
    }
