...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzDecode(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzLock(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzBootLock(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzUnLock(&Input, SystemTable, ImageHandle);
                break;
            case 4:
