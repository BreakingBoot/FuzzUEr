...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzLabelStorageInformation(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzLabelStorageRead(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzLabelStorageWrite(&Input, SystemTable, ImageHandle);
                break;
        }
    }
