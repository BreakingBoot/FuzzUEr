...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzRegister(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzUnRegister(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzGetNextShorterInterval(&Input, SystemTable, ImageHandle);
                break;
        }
    }
