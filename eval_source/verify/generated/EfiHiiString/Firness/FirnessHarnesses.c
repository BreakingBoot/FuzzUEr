...
FuzzNewString(
    ...
    */
    ...
    CHAR8 * NewString_Arg_3 = (CHAR8 *)AllocateZeroPool(sizeof(CHAR8));
    CHAR16 * NewString_Arg_4 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    */
    ...
    switch(NewString_Arg_3_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(NewString_Arg_3), (VOID *)NewString_Arg_3);
            break;
        case 1:
        {
    ...
    switch(NewString_Arg_4_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(NewString_Arg_4), (VOID *)NewString_Arg_4);
            break;
        case 1:
        {
    ...
    // Generator Struct Variable Initialization
    {
        EFI_HII_FONT_STYLE Firness_FontStyle;
        ReadBytes(Input, sizeof(Firness_FontStyle), (VOID *)&Firness_FontStyle);
        NewString_Arg_6->FontStyle = Firness_FontStyle;
    }
    {
        UINT16 Firness_FontSize;
        ReadBytes(Input, sizeof(Firness_FontSize), (VOID *)&Firness_FontSize);
        NewString_Arg_6->FontSize = Firness_FontSize;
    }
...
FuzzSetString(
    ...
    */
    ...
    CHAR8 * SetString_Arg_3 = (CHAR8 *)AllocateZeroPool(sizeof(CHAR8));
    ...
    */
    ...
    switch(SetString_Arg_3_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(SetString_Arg_3), (VOID *)SetString_Arg_3);
            break;
        case 1:
        {
    ...
    // Generator Struct Variable Initialization
    {
        EFI_HII_FONT_STYLE Firness_FontStyle;
        ReadBytes(Input, sizeof(Firness_FontStyle), (VOID *)&Firness_FontStyle);
        SetString_Arg_5->FontStyle = Firness_FontStyle;
    }
    {
        UINT16 Firness_FontSize;
        ReadBytes(Input, sizeof(Firness_FontSize), (VOID *)&Firness_FontSize);
        SetString_Arg_5->FontSize = Firness_FontSize;
    }
...
FuzzGetString(
    ...
    /*
        Input Variable(s)
    */
    CHAR8 * GetString_Arg_1 = (CHAR8 *)AllocateZeroPool(sizeof(CHAR8));
    EFI_HII_HANDLE GetString_Arg_2 = 0;
    EFI_STRING_ID GetString_Arg_3 = 0;
    CHAR16 * GetString_Arg_4 = (CHAR16 *)AllocateZeroPool(sizeof(CHAR16));
    ...
    switch(GetString_Arg_1_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(GetString_Arg_1), (VOID *)GetString_Arg_1);
            break;
        case 1:
        {
    ...
    */
    ...
    // Generator Struct Variable Initialization
    {
        EFI_HII_FONT_STYLE Firness_FontStyle;
        ReadBytes(Input, sizeof(Firness_FontStyle), (VOID *)&Firness_FontStyle);
        GetString_Arg_6->FontStyle = Firness_FontStyle;
    }
    {
        UINT16 Firness_FontSize;
        ReadBytes(Input, sizeof(Firness_FontSize), (VOID *)&Firness_FontSize);
        GetString_Arg_6->FontSize = Firness_FontSize;
    }
...
FuzzGetLanguages(
    ...
    */
    ...
    CHAR8 * GetLanguages_Arg_2 = (CHAR8 *)AllocateZeroPool(sizeof(CHAR8));
    ...
    */
    ...
    switch(GetLanguages_Arg_2_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(GetLanguages_Arg_2), (VOID *)GetLanguages_Arg_2);
            break;
        case 1:
        {
...
FuzzGetSecondaryLanguages(
    ...
    */
    ...
    CHAR8 * GetSecondaryLanguages_Arg_2 = (CHAR8 *)AllocateZeroPool(sizeof(CHAR8));
    CHAR8 * GetSecondaryLanguages_Arg_3 = (CHAR8 *)AllocateZeroPool(sizeof(CHAR8));
    ...
    switch(GetSecondaryLanguages_Arg_2_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(GetSecondaryLanguages_Arg_2), (VOID *)GetSecondaryLanguages_Arg_2);
            break;
        case 1:
        {
    ...
    switch(GetSecondaryLanguages_Arg_3_choice % 2) {
        case 0:
            ReadBytes(Input, sizeof(GetSecondaryLanguages_Arg_3), (VOID *)GetSecondaryLanguages_Arg_3);
            break;
        case 1:
        {
