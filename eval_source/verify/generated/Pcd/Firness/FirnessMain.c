    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        switch(DriverChoice%31)
        {
            ...
            case 7:
                ...
                break;
            case 8:
                Status = FuzzGet8Ex(&Input, SystemTable, ImageHandle);
                break;
            case 9:
                Status = FuzzGet16Ex(&Input, SystemTable, ImageHandle);
                break;
            case 10:
                Status = FuzzGet32Ex(&Input, SystemTable, ImageHandle);
                break;
            case 11:
                Status = FuzzGet64Ex(&Input, SystemTable, ImageHandle);
                break;
            case 12:
                Status = FuzzGetPtrEx(&Input, SystemTable, ImageHandle);
                break;
            case 13:
                Status = FuzzGetBoolEx(&Input, SystemTable, ImageHandle);
                break;
            case 14:
                Status = FuzzGetSizeEx(&Input, SystemTable, ImageHandle);
                break;
            case 15:
            ...
            case 20:
                ...
                break;
            case 21:
                Status = FuzzSet8Ex(&Input, SystemTable, ImageHandle);
                break;
            case 22:
                Status = FuzzSet16Ex(&Input, SystemTable, ImageHandle);
                break;
            case 23:
                Status = FuzzSet32Ex(&Input, SystemTable, ImageHandle);
                break;
            case 24:
                Status = FuzzSet64Ex(&Input, SystemTable, ImageHandle);
                break;
            case 25:
                Status = FuzzSetPtrEx(&Input, SystemTable, ImageHandle);
                break;
            case 26:
                Status = FuzzSetBoolEx(&Input, SystemTable, ImageHandle);
                break;
            case 27:
