...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzCancel(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzPoll(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzConnect(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzClose(&Input, SystemTable, ImageHandle);
                break;
            case 4:
                Status = FuzzConfigure(&Input, SystemTable, ImageHandle);
                break;
            case 5:
                Status = FuzzGetModeData(&Input, SystemTable, ImageHandle);
                break;
            case 6:
                Status = FuzzTransmit(&Input, SystemTable, ImageHandle);
                break;
            case 7:
                Status = FuzzReceive(&Input, SystemTable, ImageHandle);
                break;
            case 8:
                Status = FuzzRoutes(&Input, SystemTable, ImageHandle);
                break;
            case 9:
                Status = FuzzAccept(&Input, SystemTable, ImageHandle);
                break;
        }
    }
