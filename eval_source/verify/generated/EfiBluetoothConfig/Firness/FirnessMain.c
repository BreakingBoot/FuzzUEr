    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        switch(DriverChoice%11)
        {
            ...
            case 6:
                ...
                break;
            case 7:
                Status = FuzzRegisterPinCallback(&Input, SystemTable, ImageHandle);
                break;
            case 8:
                Status = FuzzRegisterGetLinkKeyCallback(&Input, SystemTable, ImageHandle);
                break;
            case 9:
                Status = FuzzRegisterSetLinkKeyCallback(&Input, SystemTable, ImageHandle);
                break;
            case 10:
