...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzOutputString(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzTestString(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzQueryMode(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzSetMode(&Input, SystemTable, ImageHandle);
                break;
            case 4:
                Status = FuzzSetAttribute(&Input, SystemTable, ImageHandle);
                break;
            case 5:
                Status = FuzzClearScreen(&Input, SystemTable, ImageHandle);
                break;
            case 6:
                Status = FuzzSetCursorPosition(&Input, SystemTable, ImageHandle);
                break;
            case 7:
                Status = FuzzEnableCursor(&Input, SystemTable, ImageHandle);
                break;
            case 8:
