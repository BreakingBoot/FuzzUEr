    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        switch(DriverChoice%7)
        {
            case 0:
                ...
                break;
            case 1:
                Status = FuzzGetBlockSize(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzGetAttributes(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzGetPhysicalAddress(&Input, SystemTable, ImageHandle);
                break;
            case 4:
                Status = FuzzEraseBlocks(&Input, SystemTable, ImageHandle);
                break;
            case 5:
