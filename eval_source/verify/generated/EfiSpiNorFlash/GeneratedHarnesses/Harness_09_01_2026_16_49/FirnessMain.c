...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzGetFlashid(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzReadData(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzLfReadData(&Input, SystemTable, ImageHandle);
                break;
            case 3:
                Status = FuzzReadStatus(&Input, SystemTable, ImageHandle);
                break;
            case 4:
                Status = FuzzWriteStatus(&Input, SystemTable, ImageHandle);
                break;
            case 5:
                Status = FuzzWriteData(&Input, SystemTable, ImageHandle);
                break;
            case 6:
                Status = FuzzErase(&Input, SystemTable, ImageHandle);
                break;
        }
    }
