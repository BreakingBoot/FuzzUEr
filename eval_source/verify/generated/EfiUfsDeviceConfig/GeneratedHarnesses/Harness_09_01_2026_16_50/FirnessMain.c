...
FirnessMain (
    ...
    for (Step = 0; Step < Steps; Step++) {
        ...
        {
            case 0:
                Status = FuzzRwUfsDescriptor(&Input, SystemTable, ImageHandle);
                break;
            case 1:
                Status = FuzzRwUfsFlag(&Input, SystemTable, ImageHandle);
                break;
            case 2:
                Status = FuzzRwUfsAttribute(&Input, SystemTable, ImageHandle);
                break;
        }
    }
