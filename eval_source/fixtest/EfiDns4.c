...
FuzzConfigure(
    ...
    */
    ...
    Configure_Arg_1->DnsServerList = (EFI_IPv4_ADDRESS *)AllocateZeroPool((4 * sizeof(*Configure_Arg_1->DnsServerList)));
    ...
    Configure_Arg_1->DnsServerListCount = Configure_Arg_1->DnsServerListCount % (4 + 1);
    {
